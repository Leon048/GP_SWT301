...
public class AdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int todaysOrders = adminDAO.getTodaysOrders();
            int lowStock = adminDAO.getLowStockProducts();
            int pendingOrders = adminDAO.getPendingOrders();
            List<OrderDTO> newOrders = adminDAO.getNewOrders();
            DecimalFormat formatter = new DecimalFormat("#,###");  
            String formattedTotalRevenue = formatter.format(totalRevenue);

            List<Integer> monthlyRevenue = adminDAO.getMonthlyRevenue();

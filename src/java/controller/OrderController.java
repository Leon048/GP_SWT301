...
//                double totalAmount = dao.getTotalAmount(user.getUserID());
//                int cartCount = dao.getCartCount(user.getUserID());
//                
//                OrderDAO orderDAO = new OrderDAO();
//                int orderId = orderDAO.createOrderAndReturnId(user.getUserID(), name, email, phone, address, paymentMethodId, totalAmount,"Pending");
//                
...
//                } else {
//                    request.getRequestDispatcher("MainController?action=CheckOut").forward(request, response);
//                }
//            } else {

    ...
    <body class="bg-light">
        ...
        <div class="container mt-5 text-center">
            <div class="alert alert-danger p-5">
                ...
                <p class="lead">Sorry, something went wrong while processing your order. Please try again.</p>
                <a href="MainController?action=CheckOut" class="btn btn-danger mt-3">Try Again</a>
            </div>
        </div>
        <!-- Footer -->

    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="d-flex justify-content-center text-center mb-3">
                <h3 class="form-title"><i class="bi bi-plus-circle"></i> Edit New Product</h3>
            </div>
                ...
                <form action="MainController" method="POST">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="discountPercent" id="discountPercent" value="${product.discountPercent}" min="0" max="100">
                        </div>
                        <div class="col-md-6">
                            <label for="stockQuantity" class="form-label">Stock Quantity</label>
                            <input type="number" class="form-control" name="stockQuantity" id="stockQuantity" value="${product.stockQuantity}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="origin" id="origin" value="${product.origin}" required>
                        </div>
                    </div>

                    <!-- Submit Button -->
                    <div class="form-group">
                        <button type="submit" class="btn btn-success" name="action" value="EditProduct">
                            <i class="bi bi-check-circle"></i> Edit Product
                        </button>
                    </div>
                </form>
            </div>
